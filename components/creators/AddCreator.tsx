...
import { addCreatorAction } from "@/lib/actions/creator";
...
export default function CreatorForm() {
  const [lastResult, action] = useActionState(addCreatorAction, undefined);
            ...
            <SectionCard label="Identity">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="space-y-1.5">
                    ...
                    <input
                        className="w-full border border-input rounded-md h-9 px-3 text-sm bg-background outline-none"
                ...
                <div className="space-y-1.5">
                    ...
                    />
                    <p className="text-primary text-sm">{fields.email.errors}</p>
                </div>
